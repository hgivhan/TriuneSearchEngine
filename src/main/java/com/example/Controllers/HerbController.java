...
//        return new ResponseEntity<>(herbService.putUpdateHerbById(id, herb.getLatinName(), herb.getCommonName(), herb.getOtherNames(), herb.getDosage(), herb.getDescription(), herb.getEnergeticsId(), herb.getBodySystems(), herb.getActions()), HttpStatus.OK); }
//
