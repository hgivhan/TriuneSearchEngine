...
public class HerbController {
    ...
    public ResponseEntity<Herb> updateHerb(@RequestBody Herb herb, @PathVariable Long id) {
        return new ResponseEntity<>(herbService.putUpdateHerbById(id, herb.getLatinName(), herb.getCommonName(), herb.getDosage(), herb.getEnergetics(), herb.getEffects()), HttpStatus.OK); }
